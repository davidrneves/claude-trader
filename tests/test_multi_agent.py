...
class TestSignalAggregation:
    def test_unanimous_buy(self, aggregator):
        result = aggregator.aggregate(
            ...
            debate=DebateResult(
                ...
                bear_argument="Overextended short-term",
            ),
        )
    ...
    def test_unanimous_sell(self, aggregator):
        result = aggregator.aggregate(
            symbol="AAPL",
            sentiment=SentimentResult(
                score=-0.6, signal=Signal.SELL, reasoning="Negative", key_factors=[]
            ),
            technical=TechnicalResult(
                score=-0.7, signal=Signal.SELL, pattern="bearish", reasoning="Below EMA"
            ),
            fundamental=FundamentalResult(
                score=-0.5,
                signal=Signal.SELL,
            ...
            debate=DebateResult(
                ...
                verdict=Signal.SELL,
                bull_argument="Weak",
                bear_argument="Strong bearish case",
            ),
        )
    ...
    def test_mixed_signals_hold(self, aggregator):
        result = aggregator.aggregate(
            symbol="AAPL",
            sentiment=SentimentResult(
                score=0.5, signal=Signal.BUY, reasoning="Positive", key_factors=[]
            ),
            technical=TechnicalResult(
                score=-0.3, signal=Signal.SELL, pattern="mixed", reasoning="Choppy"
            ),
            fundamental=FundamentalResult(
                score=0.1,
                signal=Signal.HOLD,
            ...
            debate=DebateResult(
                ...
                bear_score=0.5,
                verdict=Signal.HOLD,
                bull_argument="Some upside",
                bear_argument="Some downside",
            ),
        )
    ...
    def test_insufficient_agreement_defaults_to_hold(self, aggregator):
        result = aggregator.aggregate(
            ...
            technical=TechnicalResult(
                score=-0.6, signal=Signal.SELL, pattern="bearish", reasoning="Downtrend"
            ),
            fundamental=FundamentalResult(
                score=0.3,
                signal=Signal.BUY,
                reasoning="Slightly undervalued",
                pe_ratio=20.0,
                revenue_growth=0.08,
            ),
            debate=DebateResult(
                ...
                bear_score=0.6,
                verdict=Signal.SELL,
                bull_argument="Sentiment strong",
                bear_argument="Technicals weak",
            ),
        )
...
class TestContrarianFilter:
    def test_contrarian_buy_negative_sentiment_positive_technical(self, aggregator):
        ...
        result = aggregator.aggregate(
            ...
            debate=DebateResult(
                ...
                bear_score=0.4,
                verdict=Signal.BUY,
                bull_argument="Contrarian opportunity",
                bear_argument="Sentiment risk",
            ),
        )
    ...
    def test_no_contrarian_when_both_positive(self, aggregator):
        result = aggregator.aggregate(
            symbol="AAPL",
            sentiment=SentimentResult(
                score=0.5, signal=Signal.BUY, reasoning="Bullish", key_factors=[]
            ),
            technical=TechnicalResult(
                score=0.6, signal=Signal.BUY, pattern="uptrend", reasoning="Trending up"
            ),
            fundamental=FundamentalResult(
                score=0.4,
                signal=Signal.BUY,
